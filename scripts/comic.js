  ...
  pageComics.forEach(comic => {
    ...
    card.innerHTML = `
      <div class="content-poster-box">
        ${(comic.isAdult && comic.createdAt >= Date.now() - 1000*60*60*24*30) ? `<span class=\"new-badge new-badge--below\"><svg width=\"24\" height=\"24\" viewBox=\"0 0 24 24\"><circle cx=\"12\" cy=\"12\" r=\"12\" fill=\"#00c13b\"/><text x=\"12\" y=\"17\" text-anchor=\"middle\" font-size=\"11\" fill=\"#fff\" font-weight=\"bold\">Шинэ</text></svg></span>` : ''}
