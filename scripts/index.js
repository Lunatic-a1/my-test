...
function renderLatestPosts() {
  ...
  latestPosts.forEach((post, idx) => {
    ...
    card.innerHTML = `
      <div class="poster-box">${idx === 0 ? '<img src=\'includes/test-poster.jpg\' alt=\'포스터\'/>' : '포스터'}</div>
      <div class="post-info">
